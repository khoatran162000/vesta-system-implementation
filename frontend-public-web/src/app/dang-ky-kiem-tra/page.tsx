...
export const metadata: Metadata = {
  ...
  description:
    "Đăng ký kiểm tra đầu vào miễn phí tại VESTA Academy để xác định trình độ và lộ trình IELTS phù hợp.",
};
      ...
      <main className="mx-auto min-h-[60vh] max-w-[1200px] px-6 py-16">
        <div className="text-center">
          ...
          <p className="mt-3 text-muted">
            Hoàn thành form bên dưới để đăng ký kiểm tra trình độ miễn phí.
          </p>
        </div>
        ...
        <div className="mt-10 flex justify-center">
          {formUrl ? (
            <iframe
              ...
              title="Form đăng ký kiểm tra đầu vào"
              loading="lazy"
            >
              Đang tải form...
            </iframe>
